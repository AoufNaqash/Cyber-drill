...
>
      ...
      <nav class="flex-1 mt-6 space-y-1">
        <router-link @click="store.closeSidebar()" to="/" active-class="bg-blue-500/20 border-l-4 border-primary" class="flex items-center px-8 py-4 text-black
 hover:bg-gray-100
 hover:pl-9 transition-all border-l-4 border-transparent">
        ...
        <router-link @click="store.closeSidebar()" to="/drills" active-class="bg-blue-500/20 border-l-4 border-primary" class="flex items-center px-8 py-4 text-black hover:bg-primary-10 hover:pl-9 transition-all border-l-4 border-transparent">
        ...
        <router-link v-if="store.currentUser?.role !== 'trainer'" @click="store.closeSidebar()" to="/results" active-class="bg-blue-500/20 border-l-4 border-primary" class="flex items-center px-8 py-4 text-black hover:bg-primary-10 hover:pl-9 transition-all border-l-4 border-transparent">
        ...
        <router-link v-if="store.currentUser?.role === 'trainer'" @click="store.closeSidebar()" to="/students" active-class="bg-blue-500/20 border-l-4 border-primary" class="flex items-center px-8 py-4 text-black hover:bg-primary-10 hover:pl-9 transition-all border-l-4 border-transparent">
        ...
        <router-link v-if="store.currentUser?.role === 'trainer'" @click="store.closeSidebar()" to="/create" active-class="bg-blue-500/20 border-l-4 border-primary" class="flex items-center px-8 py-4 text-black hover:bg-primary-10 hover:pl-9 transition-all border-l-4 border-transparent">
        ...
        <router-link @click="store.closeSidebar()" to="/profile" active-class="bg-blue-500/20 border-l-4 border-primary" class="flex items-center px-8 py-4 text-black hover:bg-primary-10 hover:pl-9 transition-all border-l-4 border-transparent">
          <svg class="w-5 h-5 text-primary-light" viewBox="0 0 24 24" fill="currentColor"><path d="M12 12a4 4 0 1 0 0-8 4 4 0 0 0 0 8zm0 2c-4 0-8 2-8 6h16c0-4-4-6-8-6z"/></svg>
